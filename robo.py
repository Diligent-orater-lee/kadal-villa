...
target_string = 'https://www.nicdarkthemes.com/themes/hotel-resort/wp/demo'  # The specific string to look for in hrefs
output_directory = './auto_files/plugins/others'  # Folder where files will be saved
